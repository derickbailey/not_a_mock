...
directly. To do so, follow these instructions:
  ...
  1. Clone the source code from http://github.com/derickbailey/not_a_mock
  ...
  4. run 'gem install -l pkg/NotAMock-#.#.#.gem' where #.#.# is the version number produced in step 2
